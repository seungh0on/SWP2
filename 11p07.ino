...
#define _DUTY_NEU 3000 // servo neutral position (90 degree)
#define _DUTY_MAX 5500 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  if (dist_ema <= _TARGET_LOW){
    ...
    myservo.writeMicroseconds(550+(dist_ema - 180)*(195/18));
  }
